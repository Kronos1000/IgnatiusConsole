//  *** Copy Text file data from here when prompted  
//What is Ingatius|General Info|A fork of the midori Project|Ronan's Alter Ego|Nothing|A
//How old Is Patrick|Patrick|21|24|19|B
//Is the Sky Blue|General Info|No|Maybe|Yes|C
//What Color is Midori|Midori|Blue|Green|Red|B
//What Flavor is Midori|Midori|Melon|Lime|Strawberry|A
//Does This Work|Testing|Maybe|No|Yes|C
//Are you sure this Works|Testing|Yes|Maybe|No|A
//Is it working|testing|Yes|No|Maybe|A


// END OF TEXT FILE DATA 
